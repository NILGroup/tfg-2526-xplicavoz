\subsection{Grad-CAM}
\label{subsubsec:eda_gradcam}
Grad-CAM (Gradient-weighted Class Activation Mapping) es una técnica de explicabilidad \textit{post-hoc} utilizada principalmente en modelos basados en capas convolucionales, por lo que se considera \textit{model-agnostic}. Su objetivo es identificar qué regiones de la entrada, o de una representación intermedia del modelo, han contribuido en mayor medida a la clasificación de una muestra concreta~\parencite{2017gradcam}.
