...
LIME (Local Interpretable Model-agnostic Explanations) es una técnica de explicabilidad ``post-hoc'' cuyo objetivo es explicar predicciones individuales mediante aproximaciones locales interpretables. Se considera agnóstico del modelo, ya que solo necesita observar las salidas para las nuevas muestras perturbadas.
