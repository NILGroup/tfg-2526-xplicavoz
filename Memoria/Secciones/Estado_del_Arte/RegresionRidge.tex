...
Este método resulta útil se desarrollan modelos con un gran número de parámetros. La multicolinealidad denota cuando dos o más predictores tienen una relación casi lineal. La regresión Ridge funciona de la siguiente manera:
