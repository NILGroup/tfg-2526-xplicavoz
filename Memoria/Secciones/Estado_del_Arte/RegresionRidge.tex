...
El método de regresión Ridge permite detectar la multicolinealidad dentro de un modelo de regresión lineal. Fue propuesto por Hoerl y Kennard y es usado para trabajar con modelos que presentan sesgo. 
...
Referencia 1: %fuente: https://dialnet.unirioja.es/servlet/articulo?codigo=5116534
...
Referencia 2: %fuente : https://www.ibm.com/es-es/think/topics/ridge-regression