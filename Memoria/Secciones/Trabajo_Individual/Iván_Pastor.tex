...
\begin{itemize}
	...
	\item Aportaciones en la memoria: Mi aportación a la memoria se ha basado en volcar todo mi trabajo a la misma. Esto se puede resumir en la escritura de las secciones del perceptrón y del Wav2Vec2 en la memoria, la redacción de los experimentos con los datasets de WaveFake y ASVSpoof2021. Además me encargué de escribir el análisis del dataset final que usamos durante el proyecto. 
	
	\item Pipeline: Adaptación del código del Wav2Vec2 para que funcione a partir de un enlace único a un audio.
\end{itemize}