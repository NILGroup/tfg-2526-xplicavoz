\subsubsection{Jorge Aured Zarzoso}
...
\begin{itemize}
	...
	\item Investigué parcialmente sobre la extracción de gráficas de la voz, para su uso en redes convolucionales (CNN).	
	 ...
	 \item Investigué sobre el estado del arte de los modelos LightGBM, Random Forest y SVM para clasificación. En dicha investigación profundicé en el funcionamiento de los modelos...
