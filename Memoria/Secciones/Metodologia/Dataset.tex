...
\begin{enumerate}
	...
	\item audioMNIST \parencite{4BECKER2024}: Este dataset cuenta con 30 mil audios de los números del 0 al 9 en inglés. Lo hemos descartado porque todos los audios son voces reales, por lo que no nos sirve para nuestra tarea.
	...
	\item Wavefake \parencite{??}: Este dataset de Kaggle cuenta con gran cantidad de audios generados. Como tal, nos sirvió para probar el primer prototipo de extracción de características y buscar librerías como librosa o speechRecognition. Este dataset, al no tener los audios reales, no nos sirve para luego desarrollar los modelos.     % poner cita
...
\hspace{.7cm}
Finalmente, el dataset por el que nos decantamos fue \href{https://www.ai4europe.eu/research/ai-catalog/odss-open-dataset-synthetic-speech}{ODSS}. Hemos usado este conjunto de audios porque ya tiene creado un par para cada audio, lo que nos ahorra tiempo de generar nuestros propios audios. A esta ventaja se le suma que ODSS ya contenía audios en inglés y en español, ambos idiomas son sumamente hablados por lo que es interesante centrarse en ellos.
