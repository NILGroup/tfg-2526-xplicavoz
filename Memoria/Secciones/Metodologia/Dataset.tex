...
\begin{enumerate}
	\item HABLA~\parencite{TamayoFlorez2023}: Este dataset cuenta con una gran cantidad de audios tanto reales, como generados (con técnicas como TTS) y voces clonadas (con técnicas como Cycle-GAN). Lo hemos descartado ya que solo tiene voces en español.
