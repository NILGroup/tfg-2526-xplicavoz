...
\begin{itemize}
	...
	\item \textbf{Precisión}: Mide la proporción de predicciones correctas sobre el total de casos evaluados. Es una métrica que se enfoca en controlar los Falsos Positivos (FP). Es útil cuando el costo de un FP es alto (por ejemplo, marcar un correo legítimo como spam). Su fórmula es: $\frac{VP}{VP + FP}$. Podría calcularse la precisión para la clase negativa también. Lo usamos en Random Forest, LightGBM, SVM, KNN, Regresión Logística y AASIST.
