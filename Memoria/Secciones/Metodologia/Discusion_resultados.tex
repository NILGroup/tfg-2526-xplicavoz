...
Los resultados de estos modelos pueden parecer extraños a primera vista puesto que estos presentan unas métricas perfectas, por ello, para explicarlo, nos apoyaremos en tres papers: \cite{firc2025deepfake,p2v2025,crossdomain2024}. Estos nos hablan de los problemas que presentan este grupo de modelos con el dataset que estamos empleando.
...
Los tres papers mencionados coinciden en que los modelos tienen dificultades mostrando buenos resultados ante audios no vistos previamente o audios que se salgan del dominio del dataset con el que fueron entrenados.
...
En cuanto a las explicaciones, el ranking de características que obtienen ambos modelos basándose en su influencia es completamente distinto lo cual nos indica que ambos modelos están aprendiendo patrones completamente distintos, enfatizando en la influencia de la arquitectura del modelo en los patrones que este aprende.

Al aplicar Shap a AASIST podemos ver como la característica más influyente es el RMS señalando que está aprendiendo patrones globales de energía mientras que en el Wav2Vec2, la característica más influyente es el Spectral Centroid, mostrando que está aprendiendo representaciones espectro-temporales.
...
Esto se ve claramente en que los modelos de deep learning dependen de características distintas dependiendo de su preentrenamiento y su arquitectura mientras que los modelos más simples obtienen las mismas características importantes y despreciaban muchas veces las demás.

En cuanto a las métricas, el AASIST y el Wav2Vec2 consiguen resultados mucho más creibles y sobre todo generalizables a otros dominios de voces mientras que las métricas perfectas de los modelos más tradicionales nos dan a entender una homogeneidad y una sencillez en el entorno en el que han sido entrenados que no se refleja en entornos más realistas donde lo más probable es que sus resultados en esos dominios sean mucho peores.