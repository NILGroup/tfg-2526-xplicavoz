...
\textbf{Resultados tras quitar la característica spectral flatness:}
\begin{itemize}
	\item Accuracy:  0.9500  (Porcentaje total de aciertos)
	\item Precision: 1.0000  (De los que dije que eran reales, ¿cuántos lo eran?)
	\item Recall:    0.9000  (De los reales, ¿cuántos detecté?)
	\item F1-Score:  0.9474  (Balance precision-recall)
	\item AUC-ROC:   0.9900  (Capacidad discriminativa)
	\item MCC:       0.9045  (Coeficiente de correlación de Matthews)
\end{itemize}
...
\textbf{Resultados tras quitar las características spectral flatness, mfcc1 y spectral bandwith:}
\begin{itemize}
	\item Accuracy:  0.6500  (Porcentaje total de aciertos)
	\item Precision: 0.7143  (De los que dije que eran reales, ¿cuántos lo eran?)
	\item Recall:    0.5000  (De los reales, ¿cuántos detecté?)
	\item F1-Score:  0.5882  (Balance precision-recall)
	\item AUC-ROC:   0.8600  (Capacidad discriminativa)
	\item MCC:       0.3145  (Coeficiente de correlación de Matthews)
\end{itemize}
...
Análisis de errores:
\begin{itemize}
	\item Verdaderos Negativos (Reales bien clasificados): 8
	\item Verdaderos Positivos (IA bien clasificados): 5
	\item Falsos Positivos (Reales clasificados como IA): 2
	\item Falsos Negativos (IA clasificados como Reales): 5
	\item Error tipo I (Falsos Positivos): 20.00%
	\item Error tipo II (Falsos Negativos): 50.00%
\end{itemize}
