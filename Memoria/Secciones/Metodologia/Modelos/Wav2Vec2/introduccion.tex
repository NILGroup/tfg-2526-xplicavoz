...
Antes de comenzar con el tratamiento de los datos, es necesario considerar las librerías empleadas. Este modelo se utiliza a través de la librería \textit{transformers}, de la cual también se importan las clases \textit{Trainer}, \textit{TrainingArguments}, \textit{Wav2Vec2ForSequenceClassification} y, especialmente relevante en esta etapa, \textit{Wav2Vec2FeatureExtractor}. Asimismo, se emplea la librería \textit{Datasets}, que no debe confundirse con las estructuras de datos de \textit{Pandas}.
