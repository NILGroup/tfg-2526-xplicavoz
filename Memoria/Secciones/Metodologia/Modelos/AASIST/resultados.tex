...
En ambas gráficas de la \autoref{fig:AASIST_global_LIG_mapas_norm}, seguimos observando actividad casi continua de los filtros bajos en los 4 segundos. Respecto al mapa de ``bonas'', destaca la región entre \textbf{1 y 2} segundos, donde hay más actividad. Esto coincide con lo mencionado en la gráfica temporal con ``logits'' de Occlusion. 
