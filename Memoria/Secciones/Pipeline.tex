...
Como cierre del proyecto, se ha desarrollado un pipeline capaz de aplicar, al audio recibido como entrada, todos los modelos de IA y XAI explicados en el capítulo~\textbf{\ref{sec:metodologia}}. Este pipeline tiene como objetivo reunir en un único ``notebook'' todos los modelos desarrollados a lo largo del proyecto. De este modo, facilita la comparación de resultados y explicaciones entre modelos.
...
En este capítulo, en la sección~\textbf{\ref{sec:arq_pipeline}} explicamos la estructura que hemos seguido para desarrollar el pipeline. Después, hemos dedicado una sección para cada modelo explicando como se ha realizado su integración en el pipelina. Por último, contemplamos la sección final~\textbf{\ref{sec:conc_pipeline}} donde se comentan las conclusiones del capítulo.
...
A continuación, se ejecuta la función ``\texttt{aplicar\_XAI}'' que muestra las gráficas resultantes de aplicar las técnicas de XAI explicadas en la subsección~\textbf{\ref{subsubsec:res_aasist}}.
